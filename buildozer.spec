...
# The option may be used in three ways.
# 1) A file name without a path will be added to res/values. 
# 2) A file name with a path will be added to the res/ directory matching that path. 
# 3) A directory name will be added to res/ with all its contents copied recursively.
...
# AndroidX artifact, or any library that has moved to AndroidX.
android.enable_androidx = True
